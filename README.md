...
```bash
codex plugin marketplace add jvogan/codex-binder-lane --ref v0.3.1
...
See the [0.3.1 release notes](docs/release-notes-0.3.1.md) for the exact release boundary and measured checks.
